...
from llm_client import create_llm, LLMJudge
...
class EvaluationConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "EvaluationConfig":
        ...
        return cls(
            ...
            target_provider=data.get("target_provider", "groq"),
            judge_provider=data.get("judge_provider", data.get("target_provider", "groq")),
...
class EvaluationPipeline:
    ...
    def run_and_save(self) -> Tuple[str, str]:
        self.load_attacks()
        ...
        paths = self.save_results(
            evaluation=evaluation,
            save_summary=True,
            total_runtime_seconds=total_runtime,
        )

        return paths["results_path"], paths["summary_path"]